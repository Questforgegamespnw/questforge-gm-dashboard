export const arcConfig = {
  ...
  presentationDoctrine: "Begin with an understandable military decision, reveal occupation through physical evidence, and save the full supernatural machinery for the mine.",
