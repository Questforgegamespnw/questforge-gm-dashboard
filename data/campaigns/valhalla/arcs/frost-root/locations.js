export const locations = [
  {
    ...
    availableScenes: ["scene_frostroot_post_siege_state_branch", "scene_frostroot_valkyrie_extraction"],
  ...
  },
  {
    ...
    actorsPresent: ["actor_draugr_unfinished_dead", "actor_skald_frozen_tongue", "object_frostroot_rune_node"],
    relatedThreads: ["thread_draugr_are_unfinished_dead", "thread_siege_as_distraction"],
    availableScenes: ["scene_frostroot_bifrost_drop", "scene_frostroot_outskirts_drop_skirmish", "scene_frostroot_ridge_reveal_battlefield_opens"],
  ...
  },
  {
    ...
    function: "Primary siege location and gate-facing pressure surface for the battlefield scene.",
    connectedLocations: ["location_skjoldyrs_hollow_outer_field", "location_skjoldyrs_hollow_crossroads", "location_skjoldyrs_hollow_sap_hearth"],
    actorsPresent: ["actor_jarl_eirik_skjoldrson", "actor_brinhild_field_captain", "actor_frostwake_gate_captain", "actor_frostroot_gate_defender_cluster", "actor_frostbound_brute", "actor_draugr_unfinished_dead"],
    ...
    availableScenes: ["scene_frostroot_ridge_reveal_battlefield_opens", "scene_frostroot_siege_of_skjoldyrs_hollow", "scene_frostroot_post_siege_state_branch"],
  ...
  },
  {
    ...
    function: "Runecaller placement, Rift pressure, major node, and final battlefield objective surface.",
    connectedLocations: ["location_skjoldyrs_hollow_gate_palisade", "location_skjoldyrs_hollow_root_shrine"],
    actorsPresent: ["actor_runecaller_the_director", "object_frostroot_rune_node", "object_frostroot_rift_core"],
    relatedThreads: ["thread_runecaller_directs_battle", "thread_draugr_are_unfinished_dead", "thread_uneasy_success"],
    availableScenes: ["scene_frostroot_siege_of_skjoldyrs_hollow"],
  ...
  },
  {
    ...
    connectedLocations: ["location_skjoldyrs_hollow_gate_palisade", "location_skjoldyrs_hollow_sap_hearth_cellar", "location_skjoldyrs_hollow_root_shrine"],
    actorsPresent: ["actor_torvald_brewmaster", "actor_yrsa_root_seer", "actor_jarl_eirik_skjoldrson", "actor_brinhild_field_captain"],
    relatedThreads: ["thread_sap_flow_weakening", "thread_uneasy_success"],
    availableScenes: ["scene_frostroot_post_siege_state_branch", "scene_frostroot_sap_hearth_revelry", "scene_frostroot_regroup_with_yrsa"],
  ...
  },
  {
    ...
    presentation: {
      ...
      sensory: ["Warm copper pipework sweating in the cold cellar air.", "Kegs marked by batch-runes and old knife scratches.", "Amber sap in glass inspection bulbs, one line darkening toward black.", "The smell of resin, ale, wet stone, and something burnt-metal underneath."]
    },
    ...
    connectedLocations: ["location_skjoldyrs_hollow_sap_hearth"],
    actorsPresent: ["actor_torvald_brewmaster"],
    relatedThreads: ["thread_sap_flow_weakening", "thread_uneasy_success"],
    availableScenes: ["scene_frostroot_sap_hearth_cellar_blackened_line"],
    reference: "arcs/frost-root/library/act_1/locations/sap_hearth.md",
    tags: ["act-1", "sap-hearth", "cellar", "tapworks", "sap-flow", "blackened-sap", "aftermath", "active"]
  },
  {
    ...
    actorsPresent: ["actor_yrsa_root_seer"],
    relatedThreads: ["thread_siege_as_distraction", "thread_sap_flow_weakening", "thread_uneasy_success"],
    availableScenes: ["scene_frostroot_regroup_with_yrsa", "scene_frostroot_root_shrine_too_late", "scene_frostroot_valkyrie_extraction"],
